...
public class ScoreBoardHelper {
	...
	public void remove(int n) {
		...
		Team team = getOrCreateTeam(String.valueOf(String.valueOf(String.valueOf(ChatColor.stripColor(this.tag)))) + n,
				n);
		team.unregister();
	}
	...
	public void update(Player player) {
		...
		while (n < this.list.size()) {
			Team team = getOrCreateTeam(
					String.valueOf(String.valueOf(String.valueOf(ChatColor.stripColor(this.tag)))) + n, n);
