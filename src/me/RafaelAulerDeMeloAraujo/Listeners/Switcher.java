...
/*    */ {
	...
	/*    */ {
		/*    */ Snowball s;
		/* 17 */ if (((e.getEntity() instanceof Player)) && ((e.getEntity() instanceof Player))
				&& ((e.getDamager() instanceof Snowball))
				&& (((s = (Snowball) e.getDamager()).getShooter() instanceof Player)
						&& Habilidade.getAbility((Player) s.getShooter()) == "Switcher")) {
