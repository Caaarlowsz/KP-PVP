	...
	/*    */ {
		...
		/*    */ {
			...
			/*    */ {
				...
				/* 34 */ paramPlayerPickupItemEvent.getPlayer().playSound(
						paramPlayerPickupItemEvent.getPlayer().getLocation(),
						org.bukkit.Sound.valueOf(this.main.getConfig().getString("Sound.BowlDrop")), 1.0F, 1.0F);
				/*    */ }
			/*    */ else {
 ...
 * (1).jar!\me\RafaelAulerDeMeloAraujo\Listeners\NoDrops.class Java compiler
