...
/*    */ {
	...
	/*    */ {
		...
		/* 26 */ if (label.equalsIgnoreCase("dev")) {
			...
			/* 29 */ sender
					.sendMessage("§6\u279C §cPlugin Version: §e" + KPPvP.getInstance().getDescription().getVersion());
			...
			/* 35 */ sender
					.sendMessage("§cIf you like it consider giving a §e§l\u2605\u2605\u2605\u2605\u2605 §cReview");
 ...
 * (1).jar!\me\RafaelAulerDeMeloAraujo\main\Dev.class Java compiler version: 8
