				...
				/* 67 */ if (isInt(args[2])) {
					...
					/* 69 */ for (Entity ent : p.getNearbyEntities(numero, numero, numero)) {
						...
						/*    */ {
							...
							/*    */ }
						/*    */ }
					/* 77 */ p.sendMessage(API.NomeServer + "" + "§7§ §aKit " + name
							+ " foi aplicado para os jogadores a um raio de " + numero + " blocos");
					/* 78 */ return true;
					/*    */ }
				/*    */ }
			/*    */ }
 ...
 * (1).jar!\me\RafaelAulerDeMeloAraujo\main\Skit.class Java compiler version: 8
